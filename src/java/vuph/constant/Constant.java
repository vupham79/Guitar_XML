...
public class Constant {
    ...
    public static final String OUTPUT_NHAC_CU_DONG_NAI = "output_nhac_cu_dong_nai.xml";
    public static final String OUTPUT_SAI_GON_MUSICAL = "output_saigonmusical.xml";

                        ...
                        <div class="row">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-content">
                                            <ul class="box-category">
                                                ...
                                                <li class="bgwhite"><a href="piano.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> ĐÀN PIANO </a>
                                                </li>
                            ...
                            <div class="col-lg-9">
                                <c:if var="xml" test="${not empty applicationScope.XML}">
                                    <c:import var="xslt" url="WEB-INF/xsl/piano_jsp.xsl" charEncoding="utf-8"/>

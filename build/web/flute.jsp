                        ...
                        <div class="row">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-content">
                                            <ul class="box-category">
                                                ...
                                                <li class="bgwhite"><a href="flute.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> SÁO </a>
                                                </li>
                            ...
                            <div class="col-lg-9">
                                <c:if var="xml" test="${not empty applicationScope.XML}">
                                    <c:import var="xslt" url="WEB-INF/xsl/flute_jsp.xsl" charEncoding="utf-8"/>
